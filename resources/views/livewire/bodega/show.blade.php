                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div class="flex space-x-2">
                            <a href="{{ route('bodegas.ingreso') }}" class="inline-flex items-center px-3 py-1.5 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700">
                                <i class="fas fa-plus mr-1"></i> Ingreso
                            </a>
                            <a href="{{ route('bodegas.traspaso') }}" class="inline-flex items-center px-3 py-1.5 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        ...
                        <div class="bg-gradient-to-r from-purple-500 to-purple-600 rounded-lg shadow-lg p-4 text-white">
                            <div class="flex items-center justify-between">
                                <div>
                                    <p class="text-purple-100 text-sm">Fecha de creación</p>
                                    <p class="text-xl font-bold">{{ $bodega->created_at->format('d/m/Y') }}</p>
                                </div>
                                <i class="fas fa-calendar-alt text-4xl text-purple-200 opacity-50"></i>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border-b border-gray-200">
                        <nav class="-mb-px flex space-x-8">
                            <button class="tab-button active border-blue-500 text-blue-600 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm" 
                                    data-tab="productos">
                    ...
                    <div class="mt-6">
                        ...
                        <div id="tab-movimientos" class="tab-content hidden">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                ...
                                <div>
                                    <select wire:model.live="filtroTipo" class="block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md">
